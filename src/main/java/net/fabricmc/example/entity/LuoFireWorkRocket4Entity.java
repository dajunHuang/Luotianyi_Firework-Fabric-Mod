...
public class LuoFireWorkRocket4Entity
        extends ProjectileEntity
        implements FlyingItemEntity {
    private static final TrackedData<ItemStack> ITEM = DataTracker.registerData(LuoFireWorkRocket4Entity.class, TrackedDataHandlerRegistry.ITEM_STACK);
    private static final TrackedData<OptionalInt> SHOOTER_ENTITY_ID = DataTracker.registerData(LuoFireWorkRocket4Entity.class, TrackedDataHandlerRegistry.OPTIONAL_INT);
    private static final TrackedData<Boolean> SHOT_AT_ANGLE = DataTracker.registerData(LuoFireWorkRocket4Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private int life;
    @Nullable
    private LivingEntity shooter;
    public static final byte LUO_EXPLODE_FIREWORK_CLIENT4 = 72;

    //private MinecraftClient mc = MinecraftClient.getInstance();


    public LuoFireWorkRocket4Entity(EntityType<? extends LuoFireWorkRocket4Entity> entityType, World world) {
        super((EntityType<? extends ProjectileEntity>)entityType, world);
    }

    public LuoFireWorkRocket4Entity(World world, double x, double y, double z, ItemStack stack) {
        super((EntityType<? extends ProjectileEntity>) ExampleMod.LuoFireWorkRocket4EntityType, world);
        this.life = 0;
    ...
    public LuoFireWorkRocket4Entity(World world, @Nullable Entity entity, double x, double y, double z, ItemStack stack) {
        this(world, x, y, z, stack);
        this.setOwner(entity);
    }
    public LuoFireWorkRocket4Entity(World world, ItemStack stack, LivingEntity shooter) {
    ...
    public LuoFireWorkRocket4Entity(World world, ItemStack stack, double x, double y, double z, boolean shotAtAngle) {
        this(world, x, y, z, stack);
    ...
    public ItemStack getStack() {
        ...
        return itemStack.isEmpty() ? new ItemStack(ExampleMod.LuoFireWorkRocket4Item) : itemStack;
    }
    ...
    public void tick() {
        ...
        if (this.world.isClient && this.life % 2 < 2) {
            ...
            //this.mc.particleManager.addParticle(ParticleTypes.FIREWORK, this.getX(), this.getY(), this.getZ(), this.random.nextGaussian() * 0.05, -this.getVelocity().y * 0.5, this.random.nextGaussian() * 0.05);
        }
    ...
    private void explodeAndRemove() {
        this.world.sendEntityStatus(this, LUO_EXPLODE_FIREWORK_CLIENT4);
...
//无限
    ...
    public void handleStatus(byte status) {
        if (status == LUO_EXPLODE_FIREWORK_CLIENT4 && this.world.isClient) {
            double pattern [][] = {{0.075, 0}, {0.175, 0.15}, {0.35, 0.15}, {0.475, 0}, {0.35, -0.15}, {0.175, -0.15}, {0.075, 0},
                    {0, 0.15}, {-0.1, 0.225}, {-0.275, 0.275}, {-0.5, 0.2}, {-0.6, 0}, {-0.5, -0.2}, {-0.275, -0.275}, {-0.1, -0.225}, {-0.025, -0.125}, {0, -0.15}, {-0.075, 0},
                    {-0.175, 0.15}, {-0.375, 0.15}, {-0.475, 0}, {-0.375, -0.15}, {-0.175, -0.15}, {-0.075, 0}, {0, -0.15},
                    {0.1, -0.225}, {0.4, -0.27}, {0.5, -0.2}, {0.6, 0}, {0.5, 0.2}, {0.275, 0.275}, {0.125, 0.25}, {0.02, 0.15}};
            this.explodeStar(0.75, pattern);
        }
